...
public class ClientTokenServiceImpl implements ClientTokenService {
  ...
  private static final String GET_GENERAL_TOKEN_STATUS_ENDPOINT = "tokens/status/{tokenString}";
  ...
  @Override
  public TokenStatusResponse getGeneralTokenStatus(String tokenString) {
